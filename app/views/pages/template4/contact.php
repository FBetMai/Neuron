...
<!--CHECK-->
    <!-- * Question - Loop for printing Aside colunm (Picture, buttons)-->
    <!--Google Maps API-->
    <!--LinkedIn CHAT API-->
    ...
    <div class="col-lg-10 col-md-9 col-sm-12">        
            <section>
                    <div class="card" style="width: auto;">
                        <img  class="img-fluid" style="width: 100%; max-height: 500px" src="./img/contact3.jpg" alt="Card image"></a>
                    </div>
            </section> 
                    ...
                    <div class="jumbotron-primary">                                
                        <div class="card text-white bg-secondary mb-3" style="max-width: 30rem;">
                            <div class="card-header">Find us</div>
                                <div class="card-body">
                                    <h4 class="card-title">Neuron is located at:</h4>
                                    <p class="text-justify">315 Levers Road, Matua</p>
                                    <p class="text-justify"> Tauranga, New Zealand</p>
                                    <p class="text-justify">Phone number: +(64) 0210111111</p>
                                </div>
                        </div>
                    </div>    
