...
/*TEXT TABLE*/
/*Home TEXT*/
INSERT INTO tbl_text (PAGEID, TEXTDESCRIPTION) VALUES (1, 'Neuron is Kiwi company that provides world class data & AI services to help their clients leverage the power of their business. Neuron can provide full data science lifecycle from descriptive and diagnostic to predictive and prescriptive analytics, taking into account data security, privacy and technology constraints. By gathering data sources into one central place, designing and implementing data science techniques - be it by modelling, machine learning or AI, we can help our clients to better understand their market, their customers and their business performance. Consequently, Neuron acts as a strategic partenner to assist businesses in making diligent and important decisions.');
